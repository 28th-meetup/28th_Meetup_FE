...
class MeetUpFirebaseService : FirebaseMessagingService() {
    ...
    private fun notificationBuilder(title: String, body: String, pendingIntent: PendingIntent) =
        NotificationCompat.Builder(this, CHANNEL_ID)
            .setLargeIcon(BitmapFactory.decodeResource(resources, com.example.meetup.R.drawable.ic_logo_foreground))
    ...
    companion object {
        private const val CHANNEL_NAME = "MeetUpNotification"
        private const val CHANNEL_DESCRIPTION = "Channel For MeetUp Notification"
