...
class SearchFoodAdapter(var manager: FragmentManager, var activity: ViewModelStoreOwner, var foodList: List<SearchFood>) :
    ...
    inner class SearchFoodViewHolder(val binding: RowSetBinding) :
